...
export function TeamHero() {
  ...
  return (
    <section className="relative min-h-[80vh] flex items-center bg-bg">
      {/* Main content container - Practical UI: left-aligned text */}
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-16 lg:py-24 pt-[120px] lg:pt-[140px] w-full">
        <div className={`transition-all duration-700 ease-out-expo ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          ...
          <p className="font-body text-xl lg:text-2xl text-text-secondary leading-relaxed mb-12 max-w-2xl">
