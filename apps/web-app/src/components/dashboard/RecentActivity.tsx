...
const mockActivities: Activity[] = [
  {
    ...
    description: 'TechCorp has expressed interest in lifting out your team for a strategic expansion',
  ...
  },
  {
    ...
    description: 'FinanceFlow Industries viewed your team profile and capabilities overview',
  ...
  },
  {
    id: '3',
    type: 'message',
    title: 'Liftout inquiry message',
    description: 'MedTech Solutions sent you a confidential message about potential team acquisition',
  ...
  },
  {
    ...
    title: 'New liftout opportunity',
    description: 'Strategic Data Analytics Team needed for market expansion - matches your expertise',
